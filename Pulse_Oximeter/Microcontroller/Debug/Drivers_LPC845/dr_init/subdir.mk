...
CPP_SRCS += \
../Drivers_LPC845/dr_init/DR_Init.cpp 

CPP_DEPS += \
./Drivers_LPC845/dr_init/DR_Init.d 

OBJS += \
./Drivers_LPC845/dr_init/DR_Init.o 


# Each subdirectory must supply rules for building sources it contributes
Drivers_LPC845/dr_init/%.o: ../Drivers_LPC845/dr_init/%.cpp Drivers_LPC845/dr_init/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Drivers_LPC845-2f-dr_init

clean-Drivers_LPC845-2f-dr_init:
	-$(RM) ./Drivers_LPC845/dr_init/DR_Init.d ./Drivers_LPC845/dr_init/DR_Init.o

.PHONY: clean-Drivers_LPC845-2f-dr_init
