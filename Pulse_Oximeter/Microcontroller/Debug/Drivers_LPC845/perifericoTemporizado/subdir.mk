...
CPP_SRCS += \
../Drivers_LPC845/perifericoTemporizado/PerifericoTemporizado.cpp 

CPP_DEPS += \
./Drivers_LPC845/perifericoTemporizado/PerifericoTemporizado.d 

OBJS += \
./Drivers_LPC845/perifericoTemporizado/PerifericoTemporizado.o 


# Each subdirectory must supply rules for building sources it contributes
Drivers_LPC845/perifericoTemporizado/%.o: ../Drivers_LPC845/perifericoTemporizado/%.cpp Drivers_LPC845/perifericoTemporizado/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Drivers_LPC845-2f-perifericoTemporizado

clean-Drivers_LPC845-2f-perifericoTemporizado:
	-$(RM) ./Drivers_LPC845/perifericoTemporizado/PerifericoTemporizado.d ./Drivers_LPC845/perifericoTemporizado/PerifericoTemporizado.o

.PHONY: clean-Drivers_LPC845-2f-perifericoTemporizado
