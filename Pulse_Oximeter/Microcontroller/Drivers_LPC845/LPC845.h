...
//ESP: Defines creados por mi para definir los puertos como variables macro.
//ENG: Defines created by me to define ports as macro variables.
#define PUERTO0 	0
#define PUERTO1 	1
...
/* ESP: Definiciones para Systick
 * ENG: Systick definition.
 */
...
#define ISER0_DIR		(0xE000E100u)
#define ISER0			(*(uint32_t *) ISER0_DIR)

#define ICER0_DIR		(0xE000E180u)
#define ICER0			(*(uint32_t *) ISER0_DIR)
