...
#
# Script generated by Vivado on Thu Oct 09 15:43:26 -0300 2025
...
#
# Usage        : ramMem.sh
#                ramMem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ramMem.sh [-reset_run]
#                ramMem.sh [-reset_log]
#                ramMem.sh [-help]
#
...
# script info
echo -e "ramMem.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ramMem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot ramMem xil_defaultlib.ramMem -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ramMem.wdb xsim.dir libdpi.so)
...
Usage: ramMem.sh [-step]\n\
Usage: ramMem.sh [-lib_map_path]\n\
Usage: ramMem.sh [-reset_run]\n\
Usage: ramMem.sh [-reset_log]\n\
Usage: ramMem.sh [-keep_index]\n\
