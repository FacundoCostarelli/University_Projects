...
HD_PWD='C:/Users/Facun/Desktop/University_Projects/VHDL_Mini_Projects/Exercises_Guide_Chapter_6/Guia_6_First_Example/Guia_6_First_Example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myAnd2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myAnd2.tcl
