...
HD_PWD='C:/Users/Facun/Desktop/TD1_TPS_Locales/Exercise_Guide_Chapter_9/guia_9/guia_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myLatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myLatch.tcl
