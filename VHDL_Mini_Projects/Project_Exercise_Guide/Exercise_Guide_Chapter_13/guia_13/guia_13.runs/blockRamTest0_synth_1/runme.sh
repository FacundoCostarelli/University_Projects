...
HD_PWD='C:/Users/Facun/Desktop/TD1_TPS_Locales/Exercise_Guide_Chapter_13/guia_13/guia_13.runs/blockRamTest0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockRamTest0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockRamTest0.tcl
