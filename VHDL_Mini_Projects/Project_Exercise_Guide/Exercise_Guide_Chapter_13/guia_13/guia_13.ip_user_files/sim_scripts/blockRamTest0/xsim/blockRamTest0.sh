...
#
# Script generated by Vivado on Fri Jul 25 19:12:01 -0300 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blockRamTest0.sh
...
#
# Usage        : blockRamTest0.sh
#                blockRamTest0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blockRamTest0.sh [-reset_run]
#                blockRamTest0.sh [-reset_log]
#                blockRamTest0.sh [-help]
#
...
# script info
echo -e "blockRamTest0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blockRamTest0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot blockRamTest0 xil_defaultlib.blockRamTest0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blockRamTest0 -key {Behavioral:sim_1:Functional:blockRamTest0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blockRamTest0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blockRamTest0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blockRamTest0.sh [-help]\n\
Usage: blockRamTest0.sh [-step]\n\
Usage: blockRamTest0.sh [-lib_map_path]\n\
Usage: blockRamTest0.sh [-reset_run]\n\
Usage: blockRamTest0.sh [-reset_log]\n\
Usage: blockRamTest0.sh [-keep_index]\n\
Usage: blockRamTest0.sh [-noclean_files]\n\n\
