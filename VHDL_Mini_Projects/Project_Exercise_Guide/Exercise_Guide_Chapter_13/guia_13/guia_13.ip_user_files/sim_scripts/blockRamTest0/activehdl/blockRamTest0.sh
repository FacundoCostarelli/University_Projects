...
#                script (type 'blockRamTest0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Facun/Desktop/TD1_TPS_Locales/Exercise_Guide_Chapter_13/guia_13/guia_13.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
