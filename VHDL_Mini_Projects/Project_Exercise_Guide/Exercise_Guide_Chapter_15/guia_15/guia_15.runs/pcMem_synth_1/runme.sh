...
HD_PWD='C:/Users/Facun/Desktop/TD1_TPS_Locales/Exercise_Guide_Chapter_15/guia_15/guia_15.runs/pcMem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcMem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcMem.tcl
