...
HD_PWD='C:/Users/Facun/Desktop/TD1_TPS_Locales/Exercise_Guide_Chapter_8/guia_8/guia_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miniAlu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miniAlu.tcl -notrace
