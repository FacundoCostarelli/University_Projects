...
CPP_SRCS += \
../Drivers_LPC845/I2C/I2C.cpp 

CPP_DEPS += \
./Drivers_LPC845/I2C/I2C.d 

OBJS += \
./Drivers_LPC845/I2C/I2C.o 


# Each subdirectory must supply rules for building sources it contributes
Drivers_LPC845/I2C/%.o: ../Drivers_LPC845/I2C/%.cpp Drivers_LPC845/I2C/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Drivers_LPC845-2f-I2C

clean-Drivers_LPC845-2f-I2C:
	-$(RM) ./Drivers_LPC845/I2C/I2C.d ./Drivers_LPC845/I2C/I2C.o

.PHONY: clean-Drivers_LPC845-2f-I2C
