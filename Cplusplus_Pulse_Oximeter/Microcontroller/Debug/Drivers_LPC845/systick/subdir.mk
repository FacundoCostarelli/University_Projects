...
CPP_SRCS += \
../Drivers_LPC845/systick/Systick.cpp 

CPP_DEPS += \
./Drivers_LPC845/systick/Systick.d 

OBJS += \
./Drivers_LPC845/systick/Systick.o 


# Each subdirectory must supply rules for building sources it contributes
Drivers_LPC845/systick/%.o: ../Drivers_LPC845/systick/%.cpp Drivers_LPC845/systick/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Drivers_LPC845-2f-systick

clean-Drivers_LPC845-2f-systick:
	-$(RM) ./Drivers_LPC845/systick/Systick.d ./Drivers_LPC845/systick/Systick.o

.PHONY: clean-Drivers_LPC845-2f-systick
