/**
 * @file    sock-lib.c
 * @brief   [ESP] Librería auxiliar de sockets. 2do Recup 2023.
 *          [ENG] Socket helper library. 2nd Makeup exam 2023.
 *
...
/**
 * @brief [ESP] Conecta un cliente al servidor usando configuración de Sockets UNIX de TCP.
 *        [ENG] Connects client to server with UNIX TCP sockets config.
 */
...
/**
 * @brief [ESP] Declara socket para el servidor.
 *        [ENG] Open a server socket.
 */
...
/**
 * @brief [ESP] Función para aceptar pedidos entrantes de clientes en la cola.
 *        [ENG] Function for accepting incoming requests from clients in the queue.
 */
