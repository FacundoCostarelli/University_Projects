/**
 * @file    main.c
 * @brief   [ESP] Archivo main usando estructuras de la "Resolución Simplificada". Final 2023.
 *          [ENG] Main file using simplified resolution structures. Final 2023.
 *
...
/**
 * @brief [ESP] Función de ejecución principal (simplified).
 *        [ENG] Main execution function (simplified).
 *
 * @param argc [ESP] Cantidad de argumentos / [ENG] Number of arguments
 * @param argv [ESP] Vector de params / [ENG] Parameter vectors
