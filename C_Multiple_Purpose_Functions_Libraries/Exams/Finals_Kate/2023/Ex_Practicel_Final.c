 ...
 * @brief   [ESP] Ejercicio práctico VF - Final 2023. Archivos y linked lists.
 *          [ENG] Practical Exercise VF - Final 2023. Files and linked lists.
 *
...
/**
 * @brief [ESP] Ejecución principal del programa de filtrado y creación de Nodos.
 *        [ENG] Main execution of filtering and node creation program.
 */
...
int CargarProductos(const char *nombreArchivo, Producto_t ***listado)
{
    ...
    /* [ESP] Pregunto si la lista esta vacia / [ENG] Checks if list is empty for LIFO */
    if(*listado == NULL)
    {
...
void ExtraerNodo_SL(Nodo_t **pINI, Nodo_t **pFIN)
{
    ...
    if(*pINI != NULL)
    {
        ...
        *pINI = (*pINI)->sig;
        ...
        printf("La lista esta vacia y no hay ningun nodo para extraer.\n");
}
