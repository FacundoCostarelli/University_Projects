# Translated Text - Difference_between_Structure_and_Union_in_C.pdf

Difficulty Level : Easy ●Last Updated : May 25, 2022
...
{    intintegre;    floatdecimal;    charname[20];
};  
// declaring union  
union union_example
{    intintegre;    floatdecimal;    charname[20];
...
Horoscope CompatibilityAre you compatible with your pa�ner &other people? Take the test - Find out the answer!NebulaLearn More
...
Article Tags : CLanguage, Difference Between
